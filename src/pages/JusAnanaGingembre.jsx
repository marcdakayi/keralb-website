...
const product = {
  ...
  description: "La puissance du gingembre frais rencontre la douceur de l'ananas camerounais. Un jus vivifiant aux vertus digestives et énergisantes reconnues.",
  volume: '300ml',
  ingredients: ['Gingembre', 'Ananas'],
  bienfaits: [
    { icon: '🔥', title: 'Énergie', desc: 'Gingembre activateur naturel' },
    { icon: '🛡️', title: 'Immunité', desc: 'Anti-inflammatoire puissant' },
    { icon: '💊', title: 'Digestion', desc: 'Favorise le transit naturel' },
    { icon: '🌡️', title: 'Circulation', desc: 'Stimule la circulation sanguine' },
  ],
  price: '2800 FCFA',
  color: '#E8A347',
  imageFront: '/images/produits/gingembre-avant.png',
  imageBack: '/images/produits/gingembre-arriere.png',
}
    ...
    >
      ...
      >
        <div
          ...
          style={{ background: `radial-gradient(ellipse 60% 60% at 70% 50%, rgba(232,163,71,0.12) 0%, transparent 70%)` }}
        />
        ...
        <div className="flex items-center justify-center relative pt-16 md:pt-0 pb-16 md:pb-0">
          <div ref={bottleRef} className="relative w-36 md:w-64 lg:w-72" style={{ transformStyle: 'preserve-3d' }}>
            <img
              ...
              style={{ filter: 'drop-shadow(0 40px 80px rgba(232,163,71,0.3))' }}
            />
          </div>
          ...
          <div className="absolute w-48 h-48 md:w-72 md:h-72 rounded-full" style={{ border: `1px solid rgba(232,163,71,0.08)` }} />
        </div>
      </section>
