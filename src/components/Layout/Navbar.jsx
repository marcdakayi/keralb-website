    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <Link to="/" className="text-2xl font-bold font-display tracking-tighter text-white hover:text-keral-yellow transition-colors flex items-center gap-2">
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[60] bg-zinc-950/95 backdrop-blur-2xl flex flex-col justify-center items-center">
          <button 
